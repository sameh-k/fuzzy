    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <section className="mt-[-500px] w-screen">
        ...
        <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72">
          {plans.map((plan) => (
            <CardContainer className="inter-var" key={plan.id}>
              <CardBody
                className={`bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black ${plan.border} border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border`}
              >
                <CardItem
                  translateZ={50}
                ...
                <CardItem
                  translateZ={60}
                  className="text-sm max-w-sm text-neutral-500 mt-2 dark:text-neutral-300"
                >
